...
export default class AddInformationSubmit extends Component{
    ...
    render(){
        ...
        const columns1 = [
            {title: '序号',dataIndex: 'orderNum',key: 'orderNum',width:'10%'},
            {title: `${allData.month}月适配改造的涉密系统名称`,dataIndex: 'systemName',key: 'systemName',width:'50%'},
            {title: '开始时间',dataIndex: 'startTime',key: 'startTime',width:'10%'},
            {title: '结束时间',dataIndex: 'finishTime',key: 'finishTime',width:'10%'},
            {title: '操作',dataIndex: 'option',key: 'option',width:'20%',
            render:(_,data)=>{
                return <span>
                        <a onClick={()=>this.editData1(data,true)}>编辑</a>
                        <Divider type="vertical"/>
                        <a onClick={()=>this.deleteData1(data,true)}>删除</a>
                        </span>
                }
            },
        ];
        const columns2 = [
            {title: '序号',dataIndex: 'orderNum',key: 'orderNum',width:'10%'},
            {title: `${allData.month}月适配改造的非涉密系统名称`,dataIndex: 'systemName',key: 'systemName',width:'50%'},
            {title: '开始时间',dataIndex: 'startTime',key: 'startTime',width:'10%'},
            {title: '结束时间',dataIndex: 'finishTime',key: 'finishTime',width:'10%'},
            {title: '操作',dataIndex: 'option',key: 'option',width:'20%',
            render:(_,data)=>{
                return <span>
                        <a onClick={()=>this.editData1(data,false)}>编辑</a>
                        <Divider type="vertical"/>
                        <a onClick={()=>this.deleteData1(data,false)}>删除</a>
                        </span>
                }
            },
        ];
        const columns3 = [
            {title: `${allData.month}月适配改造的非涉密系统名称`,dataIndex: 'name',key: 'name',width:200},
                                ...
                                return e.list.map((item, index) => {
                                    return (
                                      <tr key={index}>
                                        ...
                                        <td>{item.num}</td>
                                        <td>{item.remark}</td>
                                        <td><a onClick={()=>this.editList(item,6)}>编辑</a>　<a onClick={()=>this.deleteList(e,index,true,3,item.timestamp)}>删除</a></td>
                                      </tr>
                                    );
                                  })
                            ...
                            tableList4.length?tableList4.map(e=>{
                                return e.list.map((item, index) => {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td><a onClick={()=>this.editList(item,3)}>编辑</a>　<a onClick={()=>this.deleteList(e,index,true,4,item.timestamp)}>删除</a></td>
                                    </tr>
                                    )
                                })
                            }):<tr><td colSpan={8}><img src={empty} alt=''/></td></tr>
                                ...
                                return e.list.map((item, index) => {
                                    return (
                                      <tr key={index}>
                                        ...
                                        <td>{item.num}</td>
                                        <td>{item.remark}</td>
                                        <td><a onClick={()=>this.editList(item,6)}>编辑</a>　<a onClick={()=>this.deleteList(e,index,false,5,item.timestamp)}>删除</a></td>
                                      </tr>
                                    );
                                  })
                            }):<tr><td colSpan={8}><img src={empty} alt=''/></td></tr>
                            ...
                            tableList6.length?tableList6.map(e=>{
                                return e.list.map((item, index) => {
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>{item.num}</td>
                                        <td colSpan='3'>{item.remark}</td>
                                        <td><a onClick={()=>this.editList(item,3)}>编辑</a>　<a onClick={()=>this.deleteList(e,index,false,6,item.timestamp)}>删除</a></td>
                                    </tr>
                                    )
                                })
                            }):<tr><td colSpan={8}><img src={empty} alt=''/></td></tr>
        ...
        return(
            ...
            <div className='addInformationSubmit'>
                ...
                <Form>
                    <header id='header'>
                        {/* <div className='header-item'>填报单位：{allData.unitName}</div> */}
                        ...
                        <div className='header-item header-itembtn'>
                            {/* <div className='header-item-btn'><Button type='default'>导出excel</Button></div> */}
