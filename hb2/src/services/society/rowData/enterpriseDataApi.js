...
export async function search(id) {
  return request(`/services/code/enterpriceinfo/enterpriceinfo/${id}`);
}
...
export async function exportField(params) {
  return request('/services/code/enterpriceinfo/getAllField', {
    method: 'GET',
    body: params,
  });
}
...
export async function exportFieldDownLoad(params) {
  return request('/services/code/enterpriceinfo/export', {
    method: 'POST',
    body: params,
  }, true);
}