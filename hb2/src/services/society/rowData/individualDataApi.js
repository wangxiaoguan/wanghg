...
export async function search(id) {
  return request(`/services//code/selfemployedinfo/selfemployedinfo/${id}`);
}
...
export async function exportField(params) {
  return request('/services/code/selfemployedinfo/getAllField', {
    method: 'GET',
    body: params,
  });
}
...
export async function exportFieldDownLoad(params) {
  return request('/services/code/selfemployedinfo/export', {
    method: 'POST',
    body: params,
  }, true);
}