...
export function add(params) {
  return request('/dpac/fhdefectdefectreport/save', {
    method: 'POST',
    body: params,
  });
}
...
export function search(id) {
  return request(`/services/dpac/fhdefectdefectreport/selectById/0/${id}`);
}
...
export async function exportExcel(params) {
  ...
  return request(`/services/dpac/exportExcel/exportConsume`, 
  {
    method: 'POST',
    body:params,
  }, true);
