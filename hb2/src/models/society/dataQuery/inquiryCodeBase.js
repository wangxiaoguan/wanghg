...
import { remove, update, add, search, searchCommonDic, searchRegDic, updateCheckStatus, exportField, exportFieldDownLoad } from '@/services/society/dataQuery/inquiryCodeBaseApi';

export default {
  namespace: 'inquiryCodeBase',
  state: {
  },
  effects: {
    *remove(data, funs) {
