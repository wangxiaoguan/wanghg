...
import {remove, update, add, search, updateCheckStatus, exportField, exportFieldDownLoad} from '@/services/society/dataQuery/verificationDatabaseApi';

export default {
  namespace: 'verificationDatabase',
  state: {
  },
  effects: {
    *remove(data, funs) {
