...
import { remove, update, add, search, searchCommonDic, searchRegDic, updateCheckStatus, exportField, exportFieldDownLoad } from '@/services/society/rowData/tourismDataApi';

export default {
  namespace: 'tourismData',
  state: {
  },
  effects: {
    *remove(data, funs) {
