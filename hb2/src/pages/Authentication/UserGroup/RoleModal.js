...
@connect(({ groupRoleModal, loading }) => ({
  groupRoleModal,
  loading: loading.effects['groupRoleModal/fetch'],
}))
@Form.create()
class GroupUserModal extends PureComponent {
  ...
  okHandle = () => {
    ...
    if (selectedRowKeys.length === 0) {
      ...
      dispatch({
        type: 'groupRoleModal/addUser',
        payload: { groupId, roleIds: selectedRowKeys },
        callback: () => {
