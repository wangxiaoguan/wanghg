...
@connect(({loading, advert}) => ({
  advert,
  loadingIsShow: loading.effects['advert/update'],
  loadingDelete: loading.effects['advert/remove'],
}))
        ...
        render: (text, record) => {
          return (
            <span className='controlsContainer'>
              <a href={`#/news/advertList/advertEdit/${record.id}`}>编辑</a>
    ...
    return (
      <div className="divAreaContainer">
        <Button
          ...
          type="primary"
          onClick={() => {
            window.location.hash = '/news/advertList/advertEdit';
          }}
        >
          新建
        </Button>
