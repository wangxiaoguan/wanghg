...
class UnifiedCodeBaseInfo extends Component<any, any> {
    ...
    return (
      ...
      >
        <Spin spinning={loading}>
          <Card title={<span>统一社会信用代码库</span>}>
              ...
              <tbody>
                ...
                <tr>
                  {[
                    ...
                    createTdItem('外商投资国别', `${data.gjName || '---'}`),
                    createTdItem('货币种类', `${data.bzName || '---'}`),
                  ]}
                </tr>
                <tr>
                  {[
...
export default UnifiedCodeBaseInfo;
