...
const EDIT_HASH = '#/rawData/laborData/laborDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['laborData/remove']),
}))
class LaborData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'laborData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
