...
const EDIT_HASH = '#/rawData/diplomaticData/diplomaticDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['diplomaticData/remove']),
}))
class DiplomaticData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'diplomaticData/searchRegDic',
    ...
    this.props.dispatch(
      {
        type: 'diplomaticData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
