...
const EDIT_HASH = '#/rawData/agriculture/agricultureInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['agriculture/remove']),
}))
class Agriculture extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'agriculture/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
