...
const EDIT_HASH = '#/rawData/centralData/centralDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['centralData/remove']),
}))
class CentralData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'centralData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
