...
const EDIT_HASH = '#/rawData/judicialData/judicialDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['judicialData/remove']),
}))
class JudicialData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'judicialData/searchRegDic',
    ...
    this.props.dispatch(
      {
        type: 'judicialData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
