...
class ReligiousDataInfo extends Component<any, any> {
  ...
  render() {
    ...
    return (
      <Card title={<span><span>宗教数据</span><Button onClick={() => {
        window.history.back();
...
export default ReligiousDataInfo;