...
const EDIT_HASH = '#/rawData/culturalData/culturalDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['culturalData/remove']),
}))
class CulturalData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'culturalData/searchRegDic',
    ...
    this.props.dispatch(
      {
        type: 'culturalData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
