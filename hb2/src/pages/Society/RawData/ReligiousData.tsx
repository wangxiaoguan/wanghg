...
const EDIT_HASH = '#/rawData/religiousData/religiousDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['religiousData/remove']),
}))
class ReligiousData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'religiousData/searchRegDic',
    ...
    this.props.dispatch(
      {
        type: 'religiousData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
