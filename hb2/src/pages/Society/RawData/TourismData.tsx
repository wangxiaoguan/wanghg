...
const EDIT_HASH = '#/rawData/tourismData/tourismDataInfo';
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['tourismData/remove']),
}))
class TourismData extends Component<any, any> {
...
class SearchForm extends Component<any, any> {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(
      {
        type: 'tourismData/searchCommonDic',
        payLoad: '16',
        callBack: (res) => {
