...
class DiplomaticDataInfo extends Component<any, any> {
  ...
  render() {
    ...
    return (
      <Card title={<span><span>外交数据</span><Button onClick={() => {
        window.history.back();
...
export default DiplomaticDataInfo;