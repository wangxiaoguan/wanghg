...
@connect(({ loading, advert }) => ({
  advert,
  loadingIsShow: loading.effects['faultyAdvert/update'],
  loadingDelete: loading.effects['faultyAdvert/remove'],
}))
class AdvertList extends Component {
        ...
        render: (text, record) => {
          return (
            <span className='controlsContainer'>
              <a href={`#/defectProductContent/AdvertList/AdvertEdit/${record.id}`}>编辑</a>
  ...
  searchCreater(formValues, pageSize, current) {
    return `/services/indexManage/image/list/${current}/${pageSize}?Q=module_EQ=defect`;
  }
    ...
    return (
      <div className="divAreaContainer">
        <Button
          ...
          type="primary"
          onClick={() => {
            window.location.hash = '/defectProductContent/AdvertList/AdvertEdit/';
          }}
        >
          新建
        </Button>
