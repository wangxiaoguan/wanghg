...
@connect(({ roleUserModal, loading }) => ({
  roleUserModal,
  loading: loading.effects['roleUserModal/fetch'],
}))
@Form.create()
class roleUserModal extends PureComponent {
  ...
  okHandle = () => {
    ...
    if (selectedRowKeys.length === 0) {
      ...
      dispatch({
        type: 'roleUserModal/bindUser',
        payload: { roleId, userIds: selectedRowKeys },
        callback: () => {
