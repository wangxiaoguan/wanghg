...
@connect(({ roleGroupModal, loading }) => ({
  roleGroupModal,
  loading: loading.effects['roleGroupModal/fetch'],
}))
@Form.create()
class roleGroupModal extends PureComponent {
  state = {
    formValues: {},
    selectedRowKeys: [],
  };
  ...
  okHandle = () => {
    ...
    if (selectedRowKeys.length === 0) {
      ...
      dispatch({
        type: 'roleGroupModal/bindGroup',
        payload: { roleId, groupIds: selectedRowKeys },
        callback: () => {
