...
@connect(({ loading, advert }) => ({
  advert,
  loadingIsShow: loading.effects['wtoAdvert/update'],
  loadingDelete: loading.effects['wtoAdvert/remove'],
}))
class AdvertList extends Component {
        ...
        render: (text, record) => {
          return (
            <span className='controlsContainer'>
              <a href={`#/SynthesizeManage/AdvertList/AdvertEdit/${record.id}`}>编辑</a>
  ...
  searchCreater(formValues, pageSize, current) {
    return `/services/indexManage/image/list/${current}/${pageSize}?Q=module_EQ=wto`;
  }
    ...
    return (
      <div className="divAreaContainer">
        <Button
          ...
          type="primary"
          onClick={() => {
            window.location.hash = '/SynthesizeManage/AdvertList/AdvertEdit';
          }}
        >
          新建
        </Button>
