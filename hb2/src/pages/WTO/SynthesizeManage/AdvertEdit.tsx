...
import SelectedWindow from '@/components/SelectedWindows/SelectedWindow';
import { getAttatchStr, createDefaultUploadFile, NEWS_WINDOW_PROPS } from '@/utils/AntdUtil';
    ...
    return [
      ...
      },
      {
        ...
        content: getFieldDecorator('skipUrl', { initialValue: associateType === AdvertEnum.URL_AD ? orgData.skipUrl : NewsWindow.valueStrToState(orgData.newsId) })(
          associateType === AdvertEnum.URL_AD ? <HInput /> : <NewsWindow />
        )
      },
      {
        label: '图片',
