...
const EDIT_HASH = '#/wtoDictionary/NICWithICSCodeList/NICWithICSCodeEdit';
/**
 * HS码管理
 */
@connect(({ loading }) => ({
  loadingDelete: Boolean(loading.effects['NICWithICSCode/remove']),
}))
class NICWithICSCodeEdit extends Component<IDispatchInterface, any> {
  ...
  searchCreater = (values: any, pageSize: number, current: number) => {
    return `services/wto/industryics/list/${current}/${pageSize}/${createSearchString(values)}`;
  }
...
export default NICWithICSCodeEdit;