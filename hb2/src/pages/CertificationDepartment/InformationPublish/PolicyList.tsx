...
const EDIT_HASH = '#/CerInformationPublish/PolicyList/PolicyEdit';
...
class PolicyList extends Component<IDispatchInterface, any> {
  private COLUMNS: any[] = [
    {
      title: '政策法规主题',
      dataIndex: 'title',
  ...
  searchCreater = (values: any, pageSize: number, current: number) => {
    const data = filterOb({ publishColumn: 1, ...values })
