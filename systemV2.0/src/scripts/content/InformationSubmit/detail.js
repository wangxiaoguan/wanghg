              ...
              <table className="capitalTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <th>日期</th>
                    <th>金额（万元）</th>
                    <td style={{textAlign:'left'}} colSpan="2" rowSpan='2'>{allData.adjustInfo||'　'}</td>
                  </tr>
                  <tr>
        ...
        const remarksTable = () => {
          return(
            <div className='remarksTable'>
              ...
              <td style={{textAlign:'left'}} rowSpan='3'>{allData.otherItem||"　"}</td>
						</tr>
						<tr>
							<td>台账预算外投资经费(万元)</td>
							<td>台账外新增终端数量(台)</td>
                ...
                <div className='addInformationSubmit'>
                    <header id='header'>
                        ...
                        <div className='header-item'>
                            ...
                            <Button type='primary' onClick={this.exportExcel}>导出电子表格</Button>
                        </div>
                    </header>
                    <div id='empty'></div>
