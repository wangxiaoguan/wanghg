...
import { BEGIN,setArticleData,setArticleAdd } from '../../../../../redux-root/action';
...
export default class ArticleAttach extends  Component {
  ...
  handleSearch=(value,url,qfilter)=>{
    this.props.setTableData(ServiceApi + `${url}/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}?Q=title_S_LK=${value}&&${qfilter}`);
}
  render(){
