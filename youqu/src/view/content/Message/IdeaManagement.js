...
class IdeaManagement extends Component {
  ...
  requestTypeData() {
    getService(ServiceApi + 'services/message/feedback/getOpinionType', (res) => {
  ...
  requestData() {
    ...
    getService(ServiceApi + `services/message/feedback/feedbackList/get/${this.state.current}/${PageSize}${searchStr}`, (res) => {
      if (res.retCode) {
  ...
  requestDelete() {
    if (this.state.selectedRowKeys && this.state.selectedRowKeys.length > 0) {
      postService(ServiceApi + `services/message/feedback/deleteFeedbackByIdList/delete`,
  ...
  requestAcceptIdea = (id) => {
    postService(ServiceApi + `services/message/feedback/updateAccept/${id}`, null, (res) => {
      if (res.retCode) {
        this.requestData();
      }
    });
