...
export default class Add extends Component {
  ...
  render() {
    return <EventAndInfoAdd key={this.state.update} type="event" steps={this.state.steps} style="edit" id={{ id: this.state.id }} timePush={timePush} save={'/EventManagement/Vote/List'} belonged="vote" dpRootId={this.state.dpRootId}/>;
  }
}
