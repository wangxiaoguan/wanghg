...
export default class Questions extends Component {
  ...
  getAllData=()=>{
    getService(ServiceApi + `services/activity/examActivity/activityInfo/${this.state.activityId}`,data=>{
  ...
  getEDB=()=>{
    getService(ServiceApi +`services/activity/examActivity/activityEDB/list/${this.state.activityId}`,data=>{
  ...
  getET=()=>{
    getService(ServiceApi + `services/activity/examActivity/activityET/list/${this.state.activityId}`, data => {
  ...
  handleSubmit=e=>{
    ...
    this.props.form.validateFields(['sscore', 'singleNum', 'mscore', 'multiNum', 'score', 'isTopicOrder','isOptionOrder'],(err, fieldsValue) => {
      if (!err) {
        ...
        postService(ServiceApi + 'services/activity/examActivity/updateExamActivity', values,data=>{
          console.log('data==>',data)
          if (data.retCode===1) {
  ...
  editSubmit=e=>{
    ...
    this.props.form.validateFields({},(err, fieldsValue) => {
      if (!err) {
        ...
        postService(ServiceApi + 'services/activity/examActivity/updateActivityEDB', values, data => {
          if (data.retCode === 1) {
            Message.success('保存成功!');
            this.modalCancel();
            this.getEDB();
  ...
  deleteBank=()=>{
    ...
    postService(ServiceApi +'services/activity/examActivity/deleteActivityEDB',body,data=>{
      if (data.retCode===1) {
  ...
  deleteTopic=()=>{
    ...
    postService(ServiceApi + 'services/activity/examActivity/deleteActivityET', body, data => {
  ...
  render() {
    ...
    const uploadProps = {
      name: 'file',
      action: ServiceApi + `services/activity/import/activityExamTopics?activityId=${this.state.activityId}`,
