...
export default class QuestionsConfiguration extends Component {
  ...
  componentDidMount() {
    ...
    if (this.state.isEdit) {
      getService(ServiceApi + `services/activity/examTopic/info/${this.state.id}`, data => {
        ...
        if (this.state.isEdit) {
          if (values['type'] === 1) {
            if (answerNum > 0) {
              ...
              postService(ServiceApi + 'services/activity/examTopic/update', body, data => {
                if (data.retCode === 1) {
          ...
          if (values['type'] === 1) {
            if (answerNum > 0) {
              ...
              postService(ServiceApi + 'services/activity/examTopic/insert', body, data => {
                if (data.retCode === 1) {
