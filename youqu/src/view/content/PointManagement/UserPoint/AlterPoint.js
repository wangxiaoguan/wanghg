  ...
  handleSubmit= e => {
    ...
    this.props.form.validateFields((err, fieldsValue) =>{
      ...
      if(this.state.flag == 'point'){ //经验值变更
        postService(ServiceApi + 'services/system/pointTreasure/updatePoint', values, data => {
          if(data.retCode === 1){
        ...
        postService(ServiceApi + 'services/system/pointTreasure/updateTreasure', values, data => {
          if(data.retCode === 1){
            message.success(data.retMsg);
