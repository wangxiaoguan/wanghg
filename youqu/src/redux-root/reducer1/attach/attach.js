...
import {
  ...
  ArticleAdd,ActivityAdd,FileAdd,POWERS,
...
export default combineReducers({
  powers,articleData,activityData,fileData,resultData,articleAdd,activityAdd,fileAdd,getTopicId,getPartyId,getFormData,getRecevicer
});