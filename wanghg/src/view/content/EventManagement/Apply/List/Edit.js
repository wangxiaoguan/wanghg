...
export default class Add extends Component {
  ...
  getData=()=>{
    getService(API_PREFIX +`services/activity/signUpActivity/list/1/10?Q=id_S_EQ=${this.state.id}`,data=>{
  ...
  render() {
    return <EventAndInfoAdd key={this.state.update} type="event" steps={this.state.steps} style="edit" id={{ id: this.state.id }} save={'/EventManagement/Apply/List'} timePush={timePush} belonged="apply" dpRootId={this.state.dpRootId} />;
  }
}
