    ...
    const steps = [
      {
        title: '填写活动信息',
        content: eventForm,
        url: 'services/activity/voteActivity/add',
        updateUrl: '/services/activity/voteActivity/update/activity',
        typeId: '4',
      },
      {
        title: '权限设置',
        url: 'services/activity/voteActivity/update/permission',
      },
      {
        title: '其他设置',
        content: otherForm,
        url: 'services/activity/voteActivity/update/others',

      },
    ];
    return <EventAndInfoAdd type="event" steps={steps} submitText="设置投票题目" style="add" linkTo="/EventManagement/Vote/TopicList" timePush={timePush} belonged="vote" save={'/EventManagement/Vote/List'}/>;
  }
}
const radioOption = [
  { label: '是', value: true },
...
const timePush = {
  body: {
    ...
    'operateType': 1,
    'queryType': 'post',
    'queryUrl': API_PREFIX +'services/activity/voteActivity/online',
    'queryValue': {
    },
