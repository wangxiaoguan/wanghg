...
export default class List extends Component {
  ...
  issue = (record) => {
    ...
    postService(API_PREFIX + 'services/activity/examActivity/online', body, data => {
      if (data.retCode === 1) {
  ...
  render() {
    ...
    return <Spin spinning={this.state.loading}><Tabs type="card" defaultActiveKey="0" onChange={this.tabChange} className= "tabCommon">
