    ...
    if(!this.state.isEdit){
      ...
      this.props.form.validateFields((err, values) => {
        if (!err) {
          ...
          postService(API_PREFIX + 'services/activity/goods/add',values,data => {
      ...
      this.props.form.validateFields((err, values) => {
        if (!err) {
          ...
          values.detail = this.props.editorData;
          postService(API_PREFIX + 'services/activity/goods/update',values,data => {
            if(data.retCode == 1){
