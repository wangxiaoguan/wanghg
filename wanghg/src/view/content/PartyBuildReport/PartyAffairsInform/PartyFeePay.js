...
hangleChange=(key,index,value)=>{
  ...
  getDate=()=>{
    ...
    getService(`${API_PREFIX}services/partybuildingreport/partyfee/IdAndNameList?id=306&page=0&pageSize=10`,(date)=>{
      if(date.retCode===1){
  ...
  submitSearch=(e)=>{
    ...
    //要传入输入框里面的内容和起始的时间
    getService(`${API_PREFIX}services/partybuildingreport/partyfee/IdAndNameList
