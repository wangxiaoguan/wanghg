...
//冻结/解冻 的确认点击事件
  handleConfirm=(record)=>{
    ...
    postService(API_PREFIX+'services/system/systemAndCompanyUser/update/userInfo',body,data=>{
      ...
      <Spin spinning={this.state.loading}>
          <div className="userManagement">
            ...
            <Modal
                ...
                destroyOnClose={true}
            >
            <ImportPart importUrl='services/system/import/userInfo/importUserInfo' downlodUrl={API_PREFIX + 'services/system/systemAndCompanyUser/template/export'}
