...
class NormalLoginForm extends React.Component {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if(this.props.flag){
          ...
          postService(API_PREFIX + `services/system/hotWord/add`,values, data => {
  ...
  handleConfirmPassword = (rule, value, callback) => {
      if(this.props.flag){
          ...
          postService(API_PREFIX + `services/system/hotWord/check/name`,{"id":this.props.record.id,"hotWordName":value}, data => {
              if(data.retType==0){
                this.setState({
                    validUserno:{
                      retCode:0,
        ...
        if(value == ''){
          ...
          postService(API_PREFIX + `services/system/hotWord/check/name`,{"id":"add","hotWordName":value}, data => {
              if(data.retType==0){
                this.setState({
                    validUserno:{
                      retCode:0,
