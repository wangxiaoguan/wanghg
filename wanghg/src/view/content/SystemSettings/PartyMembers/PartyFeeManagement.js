...
class PartyFeeManagement extends Component{
  ...
  if(id){
    postService(API_PREFIX+'services/system/partyFee/edit/partyFee',body,data=>{
      if(data.retCode==1){
        message.success('操作成功');
        this.props.getData(API_PREFIX+`services/system/partyFee/list/${this.state.userId}/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}?${this.props.pageData.query}`);
      }else{
