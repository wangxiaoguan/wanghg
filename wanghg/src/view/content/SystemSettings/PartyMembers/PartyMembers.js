...
class PartyMembers extends Component {
  ...
  //党费同步
  syncPartyFee = () => {
    postService(API_PREFIX + 'services/system/partyFee/syncPartyFee', '', data => {
      if (data.retCode === 1) {
        ...
        <div>
          ...
          >
            <ImportPart importUrl="services/system/import/userInfo/partyFee"
              downlodUrl={API_PREFIX + 'services/system/partyFee/template/export/partyFee'}
              fileName='党费信息模板'
          ...
          <Modal
            ...
            destroyOnClose={true}
          >
            <ImportPart importUrl="services/system/import/userInfo/partyMember" downlodUrl={API_PREFIX + 'services/system/partyMember/template/export/partyMember'}
