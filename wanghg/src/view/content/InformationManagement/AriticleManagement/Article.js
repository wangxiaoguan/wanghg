...
class Article extends Component {
  ...
  handleChangeTabs=(activeKey)=>{
    ...
    if(activeKey=='1'){
      ...
      this.props.getData(API_PREFIX+`services/news/artical/newsList/get/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}?Q=onlineState_S_EQ=1&Q=type_S_NE=6`);

    }else if(activeKey=='3'){
      this.props.getData(API_PREFIX+`services/news/artical/newsList/get/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}?Q=onlineState_S_EQ=0&Q=type_S_NE=6`);
  ...
  onTheLine=(record)=>{
    ...
    getService(API_PREFIX+`services/news/artical/newsInfo/onlineState/${record.id}/1`,data=>{
      if(data.retCode==1){
  ...
  offLine=(record)=>{
    ...
    getService(API_PREFIX+`services/news/artical/newsInfo/onlineState/${record.id}/0`,data=>{
      if(data.retCode==1){
...
//操作-专题栏目：点击事件
  ...
  previewArticle=(record)=>{
    ...
    postService(API_PREFIX+`services/activity/activity/overview`,{"content":record.content},data=>{console.log("data.root.list",data.root.list[0])
      this.setState({
