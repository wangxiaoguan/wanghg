  ...
  handleSubmit=(e)=>{
    ...
    this.props.form.validateFields((err,values)=>{
      ...
      if(this.props.isEdit){//编辑的数据
        ...
        postService(API_PREFIX + `services/news/artical/specialCategory/update`,values, data => {
          if (data.retCode == 1) {
            Message.success("修改成功!");
            this.props.getData( `${API_PREFIX+this.props.url}/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}?${this.props.pageData.query}`);
            this.props.handleOk();
          }
          else{
       ...
       let body={
        ...
        postService(API_PREFIX + `services/news/artical/specialCategory/add`,body, data => {
          if (data.retCode == 1) {
