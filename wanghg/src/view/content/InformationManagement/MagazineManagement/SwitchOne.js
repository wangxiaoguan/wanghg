...
export default class MagazineSwitchOne extends Component{
  ...
  changeUrl = () =>{
    if(this.state.activeKey==1){
      this.props.getData(API_PREFIX+`services/news/magazine/magazineList/get/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}`);
    } else if (this.state.activeKey==2){
      this.props.getData(API_PREFIX+`services/news/magazine/catalogue/list/${window.sessionStorage.getItem('magazineId')}/${this.props.pageData.currentPage}/${this.props.pageData.pageSize}`);
