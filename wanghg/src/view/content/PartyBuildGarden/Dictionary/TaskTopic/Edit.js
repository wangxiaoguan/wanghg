...
export default class Add extends  Component {
  ...
  handleSubmit=(e)=>{
    ...
    this.props.form.validateFields((err, fieldsValue)=>{
      ...
      postService(API_PREFIX+'services/partybuilding/tasktopic/update/updateTaskTopic',values,data=>{
  ...
  handleValidTopicName= (rule, value, callback) => {
    ...
    if (value == '' || value == undefined) {
      ...
      getService(API_PREFIX + `services/partybuilding/tasktopic/verifyTopicNameIsUnique/${value}/${id}`, data => {
        if (data.retCode == 0) {
