...
export default class List extends  Component {
  ...
  dealData=()=>{
    ...
    //任务主题和类型假数据
    getService(API_PREFIX+'services/partybuilding/task/taskTopicList/get/1/1000',(data)=>{
      if(data.retCode===1){
...
//终止
  ...
  offLine=(selectedRowKeys)=>{
    ...
    if(selectedRowKeys.length>0){
      let body={ids:selectedRowKeys }
      postService(API_PREFIX+`services/partybuilding/task/update/updateTasksOffline`,body,data=>{
       if (data.retCode ===1) {
