      ...
      steps:[
        {
          ...
          content:[
            ...
            { key: 'contentImage', label: '内容图片', type: 'filePicture',describe:true,hide:[4],isIamge:true,required: false,},
    ...
    return(
        <div>
          <EventAndInfoAdd
              ...
              save={`/InformationManagement/Article?tabsVale=${sessionStorage.getItem('TabsKey')}`}//返回到当前页面xwx2018/12/19
              belonged="article"
