...
export default class Add extends Component {
  ...
  render() {
    ...
    timePush={timePush} save={`/EventManagement/Questionnaire/List?id=${this.state.activeKey}`}
    belonged="questionnaire" dpRootId={this.state.dpRootId}
    datatype="questionnaire"
    getUrl={`services/web/activity/question/getById/${this.state.id}`}
    />;
  }
}
