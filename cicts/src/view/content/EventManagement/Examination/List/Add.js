...
export default class Add extends Component {
  ...
  render() {
    ...
    //   { key: 'orgId', label: '活动所属部门', type: 'cascader', required: true },
      ...
      { key: 'dayCount', label: '每人最多参与次数', type: 'inputNumber', required: true },
    ...
    const steps = [
      { 
        title: '填写活动信息',
        content: eventForm,
        url: 'services/web/activity/exam/insert',
    ...
    return <EventAndInfoAdd type="event" examination='examination' steps={steps} submitText="设置考试题目" style="add" timePush={timePush} linkTo ="EventManagement/Examination/QuestionsSettings" belonged="examination" save={'/EventManagement/Examination/List'}/>;
  }
}
const radioOption = [
  { label: '是', value: true },
