...
import './Question/Configuration.less';
    ...
    if (this.state.isEdit) {
      getService(API_PREFIX + `services/web/activity/examtitle/getById/${this.state.id}`, data => {
        ...
        if (data.status === 1) {
          ...
          this.setState({ answerGroup, typeValue: value.titleType, inputValue,showIndex:value.showIndex, inputOption, inputNum: value.optionInfos.length, anserParse: value.anserParse }, () => {
