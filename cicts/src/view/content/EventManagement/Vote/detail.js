...
export default class Detail extends Component {
  ...
  render() {
    return <EventAndInfoAdd key={this.state.update} type="event" steps={this.state.steps} style="detail" save={`/EventManagement/Vote/List?id=${this.state.activeKey}`} id={{ id: this.state.id }} belonged="vote" dpRootId={this.state.dpRootId}/>;
  }
}
const infoOption = [
