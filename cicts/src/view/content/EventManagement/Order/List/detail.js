...
export default class Detail extends Component {
  ...
  render() {
    return <EventAndInfoAdd edit='shopTimeEdit' code='orderList' key={this.state.update} save={`/EventManagement/Order/List?id=${this.state.activeKey}`} type="event" steps={this.state.steps} style="detail" id={{ id: this.state.id }} belonged="order" dpRootId={this.state.dpRootId}/>;
  }
}
const infoOption = [
