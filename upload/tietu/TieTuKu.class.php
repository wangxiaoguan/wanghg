...
class TTKClient{
	 ...
	 * @ignore
	 */
	public $upload_host = "http://up.imgapi.com/";
	/**
	 * Set timeout default.
	 *
	 * @ignore
	 ...
	 * 上传单个文件到贴图库 
	 *
	 * 对应API：{@link http://www.tietuku.com/doc#upload}
	 *
	 * @access public
	 * @param int $aid 相册ID
	...
	function uploadFile($aid,$file=null,$filename=null){
		...
		$data['file'] = curl_file_create($file, $filename);
	 ...
	 * 上传网络文件到贴图库 (只支持单个连接)
	 *
	 * 对应API：{@link http://www.tietuku.com/doc#upload-url}
	 *
	 * @access public
	 * @param int $aid 相册ID
