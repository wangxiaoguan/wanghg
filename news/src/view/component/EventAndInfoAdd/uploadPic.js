...
import ServiceApi,{PictrueUrl,UploadUrl,ChooseUrl,FileUrl,API_FILE_VIEW_INNER} from '../../content/apiprefix';
    ...
    return (
      <div>
        ...
        <Modal
          ...
          destroyOnClose
        >
          {ChooseUrl==1?<img src={PictrueUrl + this.state.current} style={{ width: '520px', height: '300px' }} />:<img src={API_FILE_VIEW_INNER + this.state.current} style={{ width: '520px', height: '300px' }} />
        ...
        <Modal
          ...
          destroyOnClose
        >
          {ChooseUrl==1?<a  className="attach" href={PictrueUrl+this.state.current} download={PictrueUrl+this.state.fileName}>{this.state.fileName}</a>:
