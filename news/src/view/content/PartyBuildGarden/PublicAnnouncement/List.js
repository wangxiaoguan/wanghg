...
export default class List extends  Component {
  ...
  dealData=()=>{
    //获取榜单信息
    getService(ServiceApi+'services/partybuilding/taskStateTxUI/boardList/get/1/1000/2',(data)=>{
      if(data.retCode===1){
  ...
  handleSubmit= e => {
    ...
    getService(ServiceApi+`services/partybuilding/taskStateTxUI/boardList/get/1/1000/${values}`,(data)=>{
      if(data.retCode===1){
        data.root.list&&data.root.list.map((item,i)=>{
          item.indexN=i+1;
        });
