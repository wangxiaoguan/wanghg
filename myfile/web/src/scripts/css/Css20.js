...
import './css.scss'
export default class Css20 extends Component{
    constructor(props){
        super(props);
        this.state={
            value: 'fixed'
            ...
            <div id='css20'> 
                <div className='left'>
                    <Radio.Group onChange={this.onChange} value={this.state.value}>
                        <Radio style={radioStyle} value={'fixed'}>background-attachment:fixed</Radio>
                        <Radio style={radioStyle} value={'scroll'}>background-attachment:scroll</Radio>
                        <Radio style={radioStyle} value={'local'}>background-attachment:local</Radio>
                    </Radio.Group>
                </div>
               <div className='right' style={{backgroundAttachment:this.state.value}}>
                    <h2>茶</h2>
