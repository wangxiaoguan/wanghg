...
// import Gif4 from './gif/Gif4'
// import Gif5 from './gif/Gif5'
// import Gif6 from './gif/Gif6'
// import Gif7 from './gif/Gif7'
// import Gif8 from './gif/Gif8'
// import Gif9 from './gif/Gif9'
// import Gif10 from './gif/Gif10'
...
class Home extends Component{
    ...
    render(){
        ...
        return(
            <div id='top'>
                {
                    // this.state.flag?<div id='homepage'><Route exact path="/" component={Root}/></div>:
                    <div>
                        <div id='leftMenu'>
                            <div style={{ width: '200px' }}>
                                <Menu mode="inline" theme="dark">
                                    <SubMenu key="sub1" title={<span><Icon type="html5" /><span>Html</span></span>}>
                                        ...
                                        {/* <Menu.Item key="111"><Link to="/app11"><p>待定</p></Link></Menu.Item> */}
                                    ...
                                    <SubMenu key="sub2" title={<span><Icon type="code-sandbox" /><span>Css</span></span>}>
                                        ...
                                        <Menu.Item key="203"><Link to="/css3"><p>Map1</p></Link></Menu.Item>
                                        <Menu.Item key="204"><Link to="/css4"><p>Map2</p></Link></Menu.Item>
                                        {/* <Menu.Item key="205"><Link to="/css5"><p>rotate</p></Link></Menu.Item> */}
                                        <Menu.Item key="206"><Link to="/css6"><p>div</p></Link></Menu.Item>
                                        {/* <Menu.Item key="207"><Link to="/css7"><p>Roll</p></Link></Menu.Item>   */}
                                        {/* <Menu.Item key="208"><Link to="/css8"><p>Carousel</p></Link></Menu.Item> */}
                                        <Menu.Item key="209"><Link to="/css9"><p>Viewer</p></Link></Menu.Item>
                                        ...
                                        <Menu.Item key="215"><Link to="/css15"><p>Chart</p></Link></Menu.Item>
                                        ...
                                        {/* <Menu.Item key="224"><Link to="/css24"><p>Form</p></Link></Menu.Item> */}
                                        ...
                                        <Menu.Item key="228"><Link to="/css28"><p>color</p></Link></Menu.Item>
                                    ...
                                    <SubMenu key="sub5" title={<span><Icon type="desktop" /><span>JavaScript</span></span>}>
                                        ...
                                        {/* <Menu.Item key="515"><Link to="/array15"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="516"><Link to="/array16"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="517"><Link to="/array17"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="518"><Link to="/array18"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="519"><Link to="/array19"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="520"><Link to="/array20"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="521"><Link to="/array21"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="522"><Link to="/array22"><p>XML</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="523"><Link to="/array23"><p>XML</p></Link></Menu.Item> */}
                                    ...
                                    <SubMenu key="sub7" title={<span><Icon type="codepen" /><span>React</span></span>}>
                                        ...
                                        {/* <Menu.Item key="705"><Link to="/react5"><p>php读写txt文件</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="706"><Link to="/react6"><p>php上传文件</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="707"><Link to="/react7"><p>前端工具</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="708"><Link to="/react8"><p>前端小知识</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="709"><Link to="/react9"><p>mainWindow</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="710"><Link to="/react10"><p>Notification</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="711"><Link to="/react11"><p>jQuery</p></Link></Menu.Item> */}
                                        {/* <Menu.Item key="712"><Link to="/react12"><p>deepClone</p></Link></Menu.Item> */}
                        ...
                        <div id='rightContent'>
                            <Switch>
                                ...
                                <Route exact path="/gif5" component={Gif5}/>
                                <Route exact path="/gif6" component={Gif6}/>
                                <Route exact path="/gif7" component={Gif7}/>
                                <Route exact path="/gif8" component={Gif8}/>
                                <Route exact path="/gif9" component={Gif9}/>
                                <Route exact path="/gif10" component={Gif10}/> */}
