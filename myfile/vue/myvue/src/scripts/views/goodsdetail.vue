<template>
    <div class="section" >
        ...
        <img :src="news.picPath" alt="" style="width:100%;margin-top:40px">
        ...
        <h4 class="car" style="margin-left:10px" >
           ...
           if(this.$router.nameId){
            this.$http.get("http://60.205.201.113:3500/shopcar",{
                ...
                MessageBox({
                    ...
                    if (action == 'confirm') {router.push({name:"login"}) }
                        }).catch(err => { 
                        if (err == 'cancel') {  } 
...
<style lang="css" scoped>
    ...
    .car{font-size:0.3rem;padding:0.1rem 0;color:red}
