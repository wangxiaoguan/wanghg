...
import { WingBlank, WhiteSpace ,Button,  Modal,ActionSheet,NavBar,Icon,Toast,Link  } from 'antd-mobile';
    ...
    render(){
        return (
            <div id="mine">
                ...
                <div className="myicon">
                    <div className="div_icon" onClick={()=>this.goItem("after1")}>
                            <i className="icon iconfont icon-daifukuan"></i>
                            <span>待付款</span>
                    </div>
                    <div className="div_icon" onClick={()=>this.goItem("after2")}>
                        <i className="icon iconfont icon-daifahuo1"></i>
                        <span>待发货</span>
                    </div>
                    <div className="div_icon" onClick={()=>this.goItem("after3")}>
                        <i className="icon iconfont icon-daishouhuo"></i>
                        <span>待收货</span>
                    </div>
                    <div className="div_icon" onClick={()=>this.goItem("after4")}>
       ...
       <List renderHeader={() => '个人中心'}>
        <Item
          ...
          arrow="horizontal" onClick={() =>this.goMy("my1")}>我的收藏</Item>
        <Item
          thumb="http://wanghg.top/images/p2.png"
          arrow="horizontal" onClick={() =>this.goMy("my2")}  >地址管理</Item>
          <Item
          thumb="http://wanghg.top/images/p3.png"
          arrow="horizontal" onClick={() =>this.goMy("my3")}>我的优惠劵</Item>
        <Item
          thumb="http://wanghg.top/images/p4.png"
          arrow="horizontal" onClick={() =>this.goMy("my4")}>我的商城币</Item>
        <Item
